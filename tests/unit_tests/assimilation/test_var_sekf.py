...
# Internal modules
from pytassim.assimilation.variational.var_sekf import VarSEKF
from pytassim.testing.dummy import dummy_h_jacob, dummy_obs_operator
...
class TestVarSEKF(DistributedCase):
    @classmethod
    ...
    def verticalize_state(state, vert_dim=4) -> xr.DataArray:
        ...
        multi_grid = pd.MultiIndex.from_tuples(zipped_grid, names=['', ''])
